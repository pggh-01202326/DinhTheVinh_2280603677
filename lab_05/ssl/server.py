...
while True:
    ...
    context.load_cert_chain(certfile="M:/DinhTheVinh_2280603677/lab_05/ssl/certificates/server-cert.crt", keyfile="M:/DinhTheVinh_2280603677/lab_05/ssl/certificates/server-key.key")
